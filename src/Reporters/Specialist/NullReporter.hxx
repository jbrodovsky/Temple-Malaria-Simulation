 ...
 * NullReporter.hxx
 *
 * This reporter is intended for situations where the model must be initialized,
 * but will not be run as a full simulation, as is the case for the
 * DxGGenerator. Nothing is recorded, and it should not be used with anything
 * else.
 */
