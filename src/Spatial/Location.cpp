...
Location::Location(const int id, float latitude, float longitude,
    ...
    : id{id},
      ...
      beta{0.0f},
      p_treatment_less_than_5{0.0f},
      p_treatment_more_than_5{0.0f},
...
Location::Location(const Location &org)
    : id{org.id},
      ...
      beta{org.beta},
      p_treatment_less_than_5(0),
      p_treatment_more_than_5(0),
...
std::ostream &operator<<(std::ostream &os, const Location &location) {
  ...
  os << "]";
  os << ", p_treatment: [" << location.p_treatment_less_than_5 << ","
     << location.p_treatment_more_than_5 << "]" << std::endl;
  return os;
}
