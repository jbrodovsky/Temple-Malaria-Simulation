...
public:
  explicit PersonIndexByLocationBitingLevel(const int &no_location = 1,
  ...
  void notify_change(Person* p, const Person::Property &property,
                     const void* oldValue, const void* newValue) override;
