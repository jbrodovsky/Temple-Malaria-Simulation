 ...
 *
 * Define the event in which the individual receives a therapy for the
 * infection.
 */
...
class ReceiveTherapyEvent : public Event {
  DELETE_COPY_AND_MOVE(ReceiveTherapyEvent)
...
public:
  ...
  std::string name() override { return "ReceiveTherapyEvent"; }
