...
void ImportationEvent::execute() {
  ...
  for (auto i = 0; i < number_of_importation_cases; i++) {
    ...
    auto* blood_parasite =
        p->add_new_parasite_to_blood(Model::CONFIG->genotype_db()->at(
