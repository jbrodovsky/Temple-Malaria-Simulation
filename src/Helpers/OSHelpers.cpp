 ...
 * OSHelpers.cpp
 *
 * Implement the defined helper functions. Note that -1 is  our default error
 * code while -2 indicates the operation was not supported.
 */
#include "OSHelpers.h"
...
int OsHelpers::getProcValue(const char* name, std::size_t length) {
