 ...
 * cpu.h
 *
 * Retrieve the vendor reported CPU Brand String (ex., Intel(R) Core(TM)
 * i7-8565U CPU @ 1.80GHz).
 */
#ifndef POMS_CPU_HXX
#define POMS_CPU_HXX
...
// Retrieve the CPU Brand String for the CPU that we are currently running on.
// This will be a human friend string, so it should only be used for basic
